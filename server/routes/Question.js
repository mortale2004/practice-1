...
const { validateQuestionTypeId, validateClassId, validateSubjectId } = require("../middleware/ExistIdValidator");

// Create question  method - POST  
router.post("/", validateQuestionTypeId, validateClassId, validateSubjectId, [
